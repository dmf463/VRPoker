...
namespace VLB
{
    ...
    {
        /// <summary>
        /// Hide flags applied to generated MeshRenderer, MeshFilter, and Material
        /// </summary>
        const HideFlags kHideFlags = HideFlags.NotEditable | HideFlags.DontSave;
        ...
        public void Initialize(VolumetricLightBeam master, Shader shader)
        {
            ...
            material.hideFlags = kHideFlags;

            meshRenderer = gameObject.GetOrAddComponent<MeshRenderer>();
            meshRenderer.hideFlags = kHideFlags;
            ...
            meshFilter.hideFlags = kHideFlags;

            gameObject.hideFlags = kHideFlags;
        }
